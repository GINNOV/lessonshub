// file: src/app/api/lessons/arkaning/route.ts
...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.error('ARKANING_LESSON_CREATE_ERROR', error);
    return new NextResponse(JSON.stringify({ error: 'Failed to create ArkanING lesson.' }), {
      status: 500,
    });
  }
}
