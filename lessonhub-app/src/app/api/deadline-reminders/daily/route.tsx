// file: src/app/api/deadline-reminders/daily/route.tsx
    ...
    try {
        ...
        for (const assignment of assignments) {
            ...
            if (student.email && lesson.teacher) {
                ...
                if (!lesson.teacher) {
                    console.log(`Skipping assignment ${assignment.id} for lesson "${lesson.title}" because it has no assigned teacher.`);
                }
            }
        }
