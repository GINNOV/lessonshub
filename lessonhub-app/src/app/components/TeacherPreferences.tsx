...
export default function TeacherPreferences({ teacher, instructionBooklets = [] }: TeacherPreferencesProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="p-6 border border-slate-800 rounded-lg bg-slate-900/70 shadow-lg">
      <h2 className="text-xl font-semibold mb-4 text-slate-50">Teacher Preferences</h2>
            ...
            {hasBooklets && (
              <div className="flex flex-col gap-2 md:flex-row md:items-center">
                <select
                  ...
                  className="rounded-md border border-slate-700 bg-slate-950 p-2 text-sm text-slate-100 shadow-sm"
                >
