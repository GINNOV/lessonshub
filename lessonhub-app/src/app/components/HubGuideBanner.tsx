...
export default function HubGuideBanner({ guideCount = 0, className }: HubGuideBannerProps) {
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div className="space-y-2 md:max-w-3xl">
          ...
          <p className="text-indigo-100/80">
            Guides are always ready for practice. No deadlines, no expirations, no grading—just a pure
            knowledge stream into your brain vessels. Some guides are free and a ton of others are for a small
            token of cash. Upgrade to unlock interactive guides between lessons.
          </p>
        </div>
        <div className="flex flex-col items-start gap-2 md:items-end">
          ...
          <div className="text-sm text-indigo-100/80">{guideCountLabel(guideCount)}</div>
        </div>
      </div>
    </div>
  );
