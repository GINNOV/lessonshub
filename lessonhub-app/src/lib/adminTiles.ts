...
export const ADMIN_TILES: AdminTile[] = [
  ...
  { href: '/admin/automation', label: 'Automation', icon: Bot, color: 'bg-gradient-to-br from-slate-900 via-slate-900/80 to-slate-950 border border-slate-800 text-slate-100 hover:border-fuchsia-400/60 hover:shadow-[0_10px_30px_rgba(217,70,239,0.18)]', iconClass: 'text-fuchsia-300' },
