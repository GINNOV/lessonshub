...
export const ADMIN_TILES: AdminTile[] = [
  { href: '/admin/users', label: 'User Management', icon: Users, color: 'bg-gradient-to-br from-slate-900 via-slate-900/80 to-slate-950 border border-slate-800 text-slate-100 hover:border-teal-400/60 hover:shadow-[0_10px_30px_rgba(45,212,191,0.18)]' },
  { href: '/admin/lessons', label: 'Lesson Management', icon: BookOpen, color: 'bg-gradient-to-br from-slate-900 via-slate-900/80 to-slate-950 border border-slate-800 text-slate-100 hover:border-violet-400/60 hover:shadow-[0_10px_30px_rgba(167,139,250,0.18)]' },
  { href: '/admin/emails', label: 'Email Editor', icon: Mail, color: 'bg-gradient-to-br from-slate-900 via-slate-900/80 to-slate-950 border border-slate-800 text-slate-100 hover:border-emerald-400/60 hover:shadow-[0_10px_30px_rgba(52,211,153,0.18)]' },
  { href: '/admin/settings', label: 'Dashboard Settings', icon: Settings, color: 'bg-gradient-to-br from-slate-900 via-slate-900/80 to-slate-950 border border-slate-800 text-slate-100 hover:border-amber-400/60 hover:shadow-[0_10px_30px_rgba(251,191,36,0.18)]' },
