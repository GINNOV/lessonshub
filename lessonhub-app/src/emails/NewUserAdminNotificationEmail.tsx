// file: src/emails/NewUserAdminNotificationEmail.tsx
import {
  Body,
  Container,
  Head,
...
export interface NewUserAdminNotificationEmailProps {
...
const NewUserAdminNotificationEmail: React.FC<Readonly<NewUserAdminNotificationEmailProps>> = ({
  adminName,
  newUserName,
  newUserEmail,
}) => {
  const previewText = `New user sign-up: ${newUserName || newUserEmail}`;
        ...
        <Container style={container}>
          <Section style={box}>
            ...
            <Text style={paragraph}>
              A new user has just signed up for LessonHUB.
            </Text>
            <Hr style={hr} />
            <Text style={paragraph}>
              <strong>Name:</strong> {newUserName || 'Not provided'}
              <br />
