...
1. Open **Create New Lesson → Create lyric** from the teacher dashboard.
...
Navigate to **Lessons → Edit** for a lyric lesson (or open the [lyric editor](/dashboard/edit/lyric/[id])). The editor pre-loads the saved timestamps, allowing you to tweak timings or regenerate lines as needed.
