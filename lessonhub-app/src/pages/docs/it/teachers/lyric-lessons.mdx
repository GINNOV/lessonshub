...
Vai su **Lezioni → Modifica** per una lezione con testo (o apri l'[editor lyric](/dashboard/edit/lyric/[id])). L'editor pre-carica i timestamp salvati, permettendoti di aggiustare i tempi o rigenerare le righe se necessario.
